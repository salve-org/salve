...
| `.request()`        | (Tree Sitter Highlighting) Requests Tree Sitter highlighting instead of normal highlights (faster but requires more work)                                                                                                                                                                                                                                                                                                                              | `command`: str, `file`: str, `language`: str , `text_range`: tuple[int, int], `tree_sitter_language`: Callable | pathlib.Path | str (should be tree-sitter-language.language() or Path/str that points to a .so file), `mapping`: dict[str, str] (see one of the examples as an example) |
